    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tableAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Table temp = new Table(String.valueOf(allTheTables.size() + 1), tableMap.this, mRootLayout);
        ...
        s.getTables(index, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try{
                    ...
                    Table temp = new Table(response.getString("name"), response.getInt("x_coord"), response.getInt("y_coord"), response.getInt("status"), "", "", tableMap.this, mRootLayout);
                    allTheTables.add(temp);
                    temp.drawManagerTable();
