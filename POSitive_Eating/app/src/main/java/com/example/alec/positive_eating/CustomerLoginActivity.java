...
public class CustomerLoginActivity extends AppCompatActivity {
    ...
    private void loadMenu(){
        startActivity(new Intent(this, CustomerMainMenu.class));
    }
    ...
    /**
     * Checks login credentials for validity. Email address must contain '@' character, password
     * must contain at least 5 characters. If both are valid, proceeds to launch CustomerMainMenu.
     */
    private void attemptLogin() {
        ...
        */
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            mPasswordView.setError("Passwords must be at least 5 letters.");
            focusView = mPasswordView;
            cancel = true;
        }
